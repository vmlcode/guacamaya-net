...
/**
 * Guacamaya-net application payload — 22 bytes, big-endian.
 *
...
data class Payload(
    ...
    init {
        ...
        require(latE7 in -90_000_000..90_000_000) { "latE7 out of range: $latE7" }
        require(lonE7 in -180_000_000..180_000_000) { "lonE7 out of range: $lonE7" }
    }
